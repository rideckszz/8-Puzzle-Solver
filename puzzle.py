...
def main():
    ...
    print("\nResultado: ",moves)
    print("\nCusto: ",len(moves))
    print("\nNodos expandidos: ",str(NodesExpanded))
    print("\nProfundidade da Pesquisa (Search Depth): ",str(deep))
    print("\nProfundidade máxida da pesquisa(Max Search Depth): ",str(MaxSearchDeep))
    print("\nTempo total de execução: ",format(time, '.8f'))

    #Generate output
    file = open('output.txt', 'w')
    file.write("Caminhos até o Destino: " + str(moves) + "\n")
    file.write("Custo do caminho: " + str(len(moves)) + "\n")
    file.write("Nodos expandidos: " + str(NodesExpanded) + "\n")
    file.write("Profundidade da Pesquisa (Search Depth): " + str(deep) + "\n")
    file.write("Profundidade máxida da pesquisa(Max Search Depth): " + str(MaxSearchDeep) + "\n")
    file.write("Tempo total de execução: " + format(time, '.8f') + "\n")
    file.close()
